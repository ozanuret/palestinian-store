    ...
    consentBanner.innerHTML = `
        <div class="cookie-banner">
            <div class="cookie-content">
                ...
                <p>Vi bruger cookies til at forbedre din oplevelse på vores website. Nogle cookies er nødvendige for, at website kan fungere, mens andre hjælper os med at forbedre vores service.</p>
                    ...
                    <div class="cookie-option">
                        <label class="cookie-checkbox">
                            ...
                            <span class="cookie-label">
                                ...
                                <small>Krævet for at website kan fungere</small>
                            </span>
                        </label>
                    </div>
                    ...
                    <div class="cookie-option">
                        <label class="cookie-checkbox">
                            ...
                            <span class="cookie-label">
                                ...
                                <small>Husker dine valg og indstillinger</small>
                            </span>
                        </label>
                    </div>
                    ...
                    <div class="cookie-option">
                        <label class="cookie-checkbox">
                            ...
                            <span class="cookie-label">
                                ...
                                <small>Hjælper os med at forbedre vores service</small>
                            </span>
                        </label>
                    </div>
                    ...
                    <div class="cookie-option">
                        <label class="cookie-checkbox">
                            ...
                            <span class="cookie-label">
                                ...
                                <small>Bruges til personlig reklame</small>
                            </span>
                        </label>
                    </div>
                </div>
                ...
                <div class="cookie-actions">
                    <button class="cookie-btn secondary" onclick="acceptAllCookies()">
                        <i class="fas fa-check"></i>
                        Accepter Alle
                    </button>
                    <button class="cookie-btn primary" onclick="saveCookiePreferences()">
                        <i class="fas fa-save"></i>
                        Gem Indstillinger
                    </button>
                    <button class="cookie-btn secondary" onclick="rejectAllCookies()">
                ...
                <div class="cookie-links">
                    <a href="privatlivspolitik.html#cookies" target="_blank">Læs mere om cookies</a>
                </div>
            </div>
        </div>
    `;
...
function saveCookiePreferences() {
    cookieConsent.preferences = document.getElementById('preferencesCookies').checked;
    cookieConsent.analytics = document.getElementById('analyticsCookies').checked;
    cookieConsent.marketing = document.getElementById('marketingCookies').checked;
    
    localStorage.setItem('cookieConsent', JSON.stringify(cookieConsent));
    localStorage.setItem('cookieConsentDate', new Date().toISOString());
    
    hideCookieConsent();
    showNotification('Cookie indstillinger gemt!', 'success');
...
function applyCookieSettings() {
    ...
    if (consent.marketing) {
        // Initialize marketing cookies (placeholder for Facebook Pixel, etc.)
...
function loadUserPreferences() {
    ...
    // Apply language immediately if it was loaded
    if (savedLanguage) {
        updateLanguage();
        updateAllContent();
    }
        ...
        <div class="cookie-settings-overlay">
            <div class="cookie-settings-modal">
                <div class="modal-header">
                    <h3><i class="fas fa-cog"></i> Cookie Indstillinger</h3>
                    <button class="close-modal" onclick="closeCookieSettings()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                
                <div class="modal-content">
                    <p>Du kan når som helst ændre dine cookie indstillinger. Nødvendige cookies kan ikke deaktiveres.</p>
                    ...
                    <div class="cookie-option">
                        <label class="cookie-checkbox">
                            <input type="checkbox" id="settingsPreferencesCookies" ${consent.preferences ? 'checked' : ''}>
                            <span class="checkmark"></span>
                            <span class="cookie-label">
                                <strong>Præference cookies</strong>
                                <small>Husker dine valg og indstillinger</small>
                    ...
                    <div class="cookie-option">
                        <label class="cookie-checkbox">
                            <input type="checkbox" id="settingsAnalyticsCookies" ${consent.analytics ? 'checked' : ''}>
                            <span class="checkmark"></span>
                            <span class="cookie-label">
                                <strong>Analytics cookies</strong>
                                <small>Hjælper os med at forbedre vores service</small>
                    ...
                    <div class="cookie-option">
                        <label class="checkbox">
                            <input type="checkbox" id="settingsMarketingCookies" ${consent.marketing ? 'checked' : ''}>
                            <span class="checkmark"></span>
                            <span class="cookie-label">
                                <strong>Marketing cookies</strong>
                                <small>Bruges til personlig reklame</small>
                ...
                <div class="modal-actions">
                    <button class="cookie-btn secondary" onclick="closeCookieSettings()">Annuller</button>
                    <button class="cookie-btn primary" onclick="updateCookieSettings()">
                        <i class="fas fa-save"></i>
                        Gem Ændringer
                    </button>
                </div>
...
function updateCookieSettings() {
    cookieConsent.preferences = document.getElementById('settingsPreferencesCookies').checked;
    cookieConsent.analytics = document.getElementById('settingsAnalyticsCookies').checked;
    cookieConsent.marketing = document.getElementById('settingsMarketingCookies').checked;
    
    localStorage.setItem('cookieConsent', JSON.stringify(cookieConsent));
    closeCookieSettings();
    showNotification('Cookie indstillinger opdateret!', 'success');
    applyCookieSettings();
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add cookie settings button to footer if it exists
    const footer = document.querySelector('.footer');
    if (footer) {
        const cookieSettingsBtn = document.createElement('button');
        cookieSettingsBtn.className = 'cookie-settings-btn';
        cookieSettingsBtn.innerHTML = '<i class="fas fa-cog"></i> Cookie Indstillinger';
        cookieSettingsBtn.onclick = showCookieSettings;
        cookieSettingsBtn.style.cssText = `
        ...
        const footerSection = footer.querySelector('.footer-section:last-child');
        if (footerSection) {
            footerSection.appendChild(cookieSettingsBtn);
        }
    }
});
